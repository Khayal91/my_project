                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $gallery_item["g_category"]; ?></td>
                                                <td>
                                                    <img class="img-rounded" width="64" height="64" src="<?php echo base_url('uploads/gallery/' . $gallery_item['g_img']); ?>" alt="ListItem">
                                                </td>
                                                <td style="width: 100px;">
                                                    <a href="<?php echo base_url('admin/gallery-edit/' . $gallery_item["g_uid"]); ?>">
                                                        <button class="btn btn-warning btn-sm">
                                                            <i class="fa fa-pencil-square-o"></i>
                                                        </button>
                                                    </a>
                                                    <a href="<?php echo base_url('admin/gallery-delete/' . $gallery_item["g_uid"]); ?>">
