                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $slider_item["s_name"]; ?></td>
                                                <td>
                                                    <img class="img-rounded" width="64" height="64" src="<?php echo base_url('uploads/slider/' . $slider_item['s_img']); ?>" alt="ListItem">
                                                </td>
                                                <td style="width: 100px;">
                                                    <a href="<?php echo base_url('admin/slider-edit/' . $slider_item["s_uid"]); ?>">
                                                        <button class="btn btn-warning btn-sm">
                                                            <i class="fa fa-pencil-square-o"></i>
                                                        </button>
                                                    </a>
                                                    <a href="<?php echo base_url('admin/slider-delete/' . $slider_item["s_uid"]); ?>">
